  ...
  return (
    <>
      <div className="bg-gray-50 mt-3 py-2">
        ...
        <div className="bg-[url('https://i.pinimg.com/1200x/eb/13/3f/eb133faea1e776c37bef1d14972bf540.jpg')] md:bg-[url('https://www.apple.com/v/iphone-air/c/images/overview/welcome/hero__pkj0eg4w6ki2_large_2x.jpg')] h-[450px] md:h-screen bg-contain md:bg-cover bg-no-repeat md:bg-center ">
        </div>
      </div>
    </>
  )
